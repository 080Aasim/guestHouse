          ...
          <div className="text">
            ...
            <div className="right-text">
              <p>
                ...
                vineyard views. Those on the front of the house have three
                windows and hillside view. The inn has central air conditioning.
                A two course gourmet breakfast is included with your room rate.
                ...
                <h5>
                  4. Pets are not allowed, but we can assist you in finding local lodging for your pet.
                </h5>
              </p>
            </div>
          </div>
